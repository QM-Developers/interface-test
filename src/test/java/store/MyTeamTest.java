...
//            String result = getDepartmentMember();
    ...
    private static String findMemberByNameOrPhone() throws IOException
    {
        String url = CoreConstant.URL_BASE_LOCAL + "/s/findMemberByNameOrPhone" + CoreConstant.URL_SUFFIX;
    ...
    private static String getDepartmentMember() throws IOException
    {
        String url = CoreConstant.URL_BASE_LOCAL + "/s/getDepartmentMember" + CoreConstant.URL_SUFFIX;
        OkHttpClient okHttpClient = new OkHttpClient.Builder().connectTimeout(1000, TimeUnit.SECONDS).build();
        ...
        params.put("token", IDGenerator.generator());
        params.put("myTeamId", "10001");
        params.put("memberId", "0420cb22c06b43a488c39967779eecec");
    ...
    private static String findDepartmentMember() throws IOException
    {
        String url = CoreConstant.URL_BASE_LOCAL + "/s/findDepartmentMember" + CoreConstant.URL_SUFFIX;
        OkHttpClient okHttpClient = new OkHttpClient.Builder().connectTimeout(1000, TimeUnit.SECONDS).build();
