...
//            String result = listOrderByKeyword();
...
//            String result = listOrderSelectiveByManager();
    ...
    {
        String url = CoreConstant.URL_BASE_LOCAL + "/s/sales/getOrder" + CoreConstant.URL_SUFFIX;
    ...
    private static String listOrderByKeyword() throws IOException
    {
        String url = CoreConstant.URL_BASE_LOCAL + "/s/sales/listOrderByKeyword" + CoreConstant.URL_SUFFIX;
        OkHttpClient okHttpClient = new OkHttpClient.Builder().connectTimeout(1000, TimeUnit.SECONDS).build();
