...
//            String result = listCustomerByKeyword();
...
//            getCustomerIDCard();
    ...
    private static String listCustomerByKeyword() throws IOException
    {
        String url = BASE_URL + "/s/listCustomerByKeyword" + CoreConstant.URL_SUFFIX;
