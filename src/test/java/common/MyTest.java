...
//            String result = deleteMyAddress();
    ...
    {
        String url = CoreConstant.URL_BASE_LOCAL + "/user_deleteMyAddress" + CoreConstant.URL_SUFFIX;
    ...
    {
        String url = CoreConstant.URL_BASE_LOCAL + "/user_updateMyAddress" + CoreConstant.URL_SUFFIX;
        OkHttpClient okHttpClient = new OkHttpClient.Builder().connectTimeout(1000, TimeUnit.SECONDS).build();
    ...
    {
        String url = CoreConstant.URL_BASE_LOCAL + "/user_findMyDefaultAddress" + CoreConstant.URL_SUFFIX;
        OkHttpClient okHttpClient = new OkHttpClient.Builder().connectTimeout(1000, TimeUnit.SECONDS).build();
    ...
    {
        String url = CoreConstant.URL_BASE_LOCAL + "/user_findMyInfo" + CoreConstant.URL_SUFFIX;
        OkHttpClient okHttpClient = new OkHttpClient.Builder().connectTimeout(1000, TimeUnit.SECONDS).build();
    ...
    {
        String url = CoreConstant.URL_BASE_LOCAL + "/user_findMyAddress" + CoreConstant.URL_SUFFIX;
        OkHttpClient okHttpClient = new OkHttpClient.Builder().connectTimeout(1000, TimeUnit.SECONDS).build();
    ...
    {
        String url = CoreConstant.URL_BASE_LOCAL + "/user_addMyAddress" + CoreConstant.URL_SUFFIX;
        OkHttpClient okHttpClient = new OkHttpClient.Builder().connectTimeout(1000, TimeUnit.SECONDS).build();
    ...
    {
        String url = CoreConstant.URL_BASE_LOCAL + "/user_uploadHeadPortrait" + CoreConstant.URL_SUFFIX;
